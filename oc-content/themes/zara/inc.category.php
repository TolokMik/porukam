...
<?php if(osc_get_preference('home_location', 'zara_theme') == 1 && osc_is_home_page()) { ?>
  <?php
    $loc_text = '';
  ...
  <div id="location-def" class="noselect">
    <a href="<?php echo osc_item_send_friend_url(); ?>" id="home-loc-open" class="l-button tr1">
      <span class="l-img">
        <img src="<?php echo osc_current_web_theme_url(); ?>images/header_loc.png" alt="<?php echo osc_esc_html(__('Location image', 'zara')); ?>" />
      </span>
