<?php
define('ZARA_THEME_VERSION', '1.0.8');
...
function zara_random_items($numItems = 10, $category = array(), $withPicture = false) {
  ...
  if($premiums == 1) {
    $whe .= ' AND ' . DB_TABLE_PREFIX . 't_item.b_premium = 1';
  }
...
function zara_max_price($cat_id = null, $country_code = null, $region_id = null, $city_id = null) {
  ...
  $maxSearch->addCity($city_id);
  $maxSearch->limit(0, osc_total_active_items());
...
function theme_zara_actions_admin() {
  ...
  switch( Params::getParam('action_specific') ) {
    case('settings'):
      ...
      $home_location = Params::getParam('home_location');
      ...
      osc_set_preference('enable_partner', ($enable_partner ? '1' : '0'), 'zara_theme');
      osc_set_preference('home_location', ($home_location ? '1' : '0'), 'zara_theme');
...
if( !function_exists('zara_theme_install') ) {
  function zara_theme_install() {
    ...
    osc_set_preference('enable_partner', '1', 'zara_theme');
