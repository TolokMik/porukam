...
<body>
  ...
  <div class="content user_account">
    ...
    <div id="main" class="dashboard">
      <h3 class="title_block"><?php echo _e('Your', 'zara'); ?> <span><?php echo _e('latest', 'zara'); ?></span> <?php echo _e('listiengs', 'zara'); ?></h3>
      ...
      <?php } else { ?>
        ...
        <?php while(osc_has_items()) { ?>
          <div class="dash-item<?php if($c%2 == 0) { ?> odd<?php } ?>">
            ...
            <span class="views"><i class="fa fa-male"></i>&nbsp;<?php echo osc_item_views(); ?></span>
