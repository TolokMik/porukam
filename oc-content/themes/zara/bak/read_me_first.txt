------- How to install? ------
- upload theme (zara.zip file) using oc-admin (themes > manage themes > add new)
- upload plugins (plugins.zip file located in zara folder) using ftp:
  -- upload plugins.zip into oc-content/plugins folder
  -- extract plugins.zip in this folder
  -- you can now delete plugins.zip file
- install all plugins from osclass oc-admin
- do not use plugins with same name that were not included in pack, do not update installed plugins
- you are done
