...
<title><?php _e('Print Ad','print_ad'); ?></title>
...
function toggle() {
	...
	if(ele.style.display == "none") {
		...
		text.innerHTML = "<?php _e('Hide photos','print_ad'); ?>";
  	}
	else {
		ele.style.display = "none";
		text.innerHTML = "<?php _e('Show photos','print_ad'); ?>";
	}
} 
</script>
...
<body id="print-ad-body">    
    <div id="title">
       ...
       <div id="print" style="font-weight:bold;padding-top: 4px;padding-right: 4px;color:#278827;"><a href="#" onclick="printpage();"><?php _e('Print!','print_ad'); ?></a></div>
    </div>
    <div id="info">
	<b><?php _e('Address','print_ad'); ?>:</b><br><?php if($contact_address!='') echo $contact_address.'<br>'; ?><?php echo $city.', '.$region; ?><br>
	<br>
	<b><?php _e('Published','print_ad'); ?>:</b><br><?php echo osc_format_date($pub_date); ?><br>
	<br>
	<b><?php _e('Contact info','print_ad'); ?>:</b><br>
        ...
        <br>
	<b><?php _e('Price','print_ad'); ?>:</b><br><?php echo $price; ?><br>
	<br>
    </div>
    ...
    <div id="desc">
        <?php
          ...
          $first = $arr[0];
        ?>
	<b><?php _e('Description', 'print_ad'); ?>:</b> <?php echo $dd[0]; ?>
    </div>

    <?php if($image_id[0]!=''){ ?>

    <div id="pictures">
    <a id="displayText" href="javascript:toggle();"><?php _e('Hide photos','print_ad'); ?></a>
	<div id="pics">
    ...
    <?php } ?>
    <div id="footer">
	<?php echo __('This listing is placed on','print_ad') . ' '; ?> <b><?php echo $site_title.'</b> - <i>'.$site_url; ?></i>
    </div>
</body>
</html>