...
function profile_picture_upload(){
    ...
    echo '<div class="left">';
    echo '<img src="' . osc_base_url() . 'oc-content/themes/zara/images/upload-picture-form.jpg">';
    echo '</div>';
   ...
   // Configuration - Your Options ///////////////////////////////////////////////////////
	...
	if($result>0 && file_exists($upload_path.'profile'.$user_id.$result['pic_ext'])){
	    echo '<div class="links"><a class="first" href="javascript:ShowDiv();">' . __('Upload new picture', 'profile_picture') . '</a> - <a class="second" href="javascript:deletePhoto();">' . __('Delete picture', 'profile_picture') . '</a></div>';
