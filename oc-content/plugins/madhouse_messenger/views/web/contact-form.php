...
<form action="<?php echo mdh_messenger_send_url(); ?>" method="post" name="contact_form">
    ...
    <div class="control-group">
        <div class="controls">
            ...
            <?php endif; ?>
            <textarea name="message" rows=" <?php if(mdh_messenger_is_contacted()) echo 13; else echo 18; ?>" placeholder="<?php _e("Write something...", 'madhouse_messenger')?>" id="quickad"><?php echo mdh_messenger_message_template(); ?></textarea>
        </div>
    </div>
    <div class="control-group">
    	<div class="controls">
