    ...
    ?>
    <?php if (mb_strlen($itmdescription,'UTF-8') > 250 && $shp_product == 1 ) { 
        ?>
         <div class="contentlimit"> 
            ...
            ?> </div> <?php 
                echo '<span class="trimed_h">' . __('The ad will look like','rbc'). '</span>';   
                echo '<br/>'.mb_substr($itmdescription,0,250,"UTF-8"); /*trim_text($itmdescription, 400, false); */ ?> 
    ...
    <div class="wrapper-pay"> 
      ...
      <div class="pay_form">
          ...
          <button class='button orange-button round2'><?php echo __('Pay for service','rbc'); ?></button>
          </form>
      </div>
    </div>
