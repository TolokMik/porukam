...
<div style="float:left; width:10%;"><h2><?php _e('Premium', 'rbc'); ?></h2></div>
<div class="ppaypal" style="background:#FF5D13 repeat-x scroll 0px 0px; width:60%; float:left;">
<p><?php _e('Premium status is when the ads are highlighted and shown on top of free ads in . This promotes more rapid sales. The duration of the option in days:', 'rbc'); ?><?php echo osc_get_preference('premium_days', 'rbc'); ?></p></div>
<div style="float:left; width:20%;"><h2><?php _e('Move ad on top', 'rbc'); ?></h2></div>
<div class="ppaypal" style="background:#14A7D1 repeat-x scroll 0px 0px; width:105px; float:left;"><h2 style="color:#FFF;padding-left:3px; float:left;"><?php _e('3x views!', 'rbc'); ?></h2>
<p><?php _e('This function moves you ad once on the top of the you category and the main page too.', 'rbc'); ?></p></div>
<div style="float:left; width:20%;"><h2><?php _e('Highlight', 'rbc'); ?></h2></div>
<div class="ppaypal" style="background:#1AAF5D repeat-x scroll 0px 0px; width:105px; float:left;"><h2 style="color:#FFF;padding-left:3px; float:left;"><?php _e('5x views!', 'rbc'); ?></h2>
<p><?php _e('This option allows to attract the visitors attention on you ads. Background of your ad becomes highlighted', 'rbc'); ?></p></div>
<br />
    ...
    <?php while(osc_has_items()) { ?>
        <div class="item">
            ...
            <p class="options">
				...
				<strong><?php _e('Already highlight!', 'rbc'); ?></strong>
				<?php } else { ?>
				<strong style="margin-left: 5px;">
