...
CREATE TABLE /*TABLE_PREFIX*/t_rbc_wallet (
...
CREATE TABLE /*TABLE_PREFIX*/t_rbc_premium (
    ...
    FOREIGN KEY (fk_i_item_id) REFERENCES /*TABLE_PREFIX*/t_item (pk_i_id),
        FOREIGN KEY (fk_i_payment_id) REFERENCES /*TABLE_PREFIX*/t_rbc_log (pk_i_id)
) ENGINE=InnoDB DEFAULT CHARACTER SET 'UTF8' COLLATE 'UTF8_GENERAL_CI';

CREATE TABLE /*TABLE_PREFIX*/t_rbc_prices (
    fk_i_category_id INT UNSIGNED NOT NULL,
    f_top_cost FLOAT NULL ,
    f_color_cost FLOAT NULL ,
...
CREATE TABLE /*TABLE_PREFIX*/t_rbc_publish (
    fk_i_item_id INT UNSIGNED NOT NULL,
    dt_date DATETIME NOT NULL ,
...
ALTER TABLE /*TABLE_PREFIX*/t_item ADD dt_r_colorized datetime NOT NULL;
